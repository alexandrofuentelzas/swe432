...
// Button labels
static String OperationAdd = "FirstSecond";
static String OperationSub = "SecondFirst";
...
{
   String rslt   = "";
   String lhsVal = ""; //rslt, lhsVal and rhsVal used Float() object 
   String rhsVal = "";
   String operation = request.getParameter("Operation");
   String lhsStr = request.getParameter("LHS");
   String rhsStr = request.getParameter("RHS");
   if ((lhsStr != null) && (lhsStr.length() > 0))
      lhsVal = lhsStr; //Was new Float()
   if ((rhsStr != null) && (rhsStr.length() > 0))
      rhsVal = rhsStr; //Was new Float()
